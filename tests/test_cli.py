...
def test_mouse_tracking_is_enabled_by_default(monkeypatch: pytest.MonkeyPatch):
...
def test_mouse_tracking_allows_enabled_values(
...
def test_mouse_tracking_can_be_disabled_explicitly(
    monkeypatch: pytest.MonkeyPatch, value: str
):
    monkeypatch.setenv("COOMI_MOUSE", value)
